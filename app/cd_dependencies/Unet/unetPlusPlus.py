...
from .basicUnet import Downscaling_layer, ExpandingLayer, DoubleConvolutionLayer, FinalLayer, Bottleneck
...
class unetPlusPlus(nn.Module):
    ...
    def __init__(self, n_channels, n_classes):
       ...
       # filter_sizes = [64, 8, 8, 8, 8]
        ...
        self.layer0_0 = DoubleConvolutionLayer(n_channels, 32)
        ...
        self.final1 = FinalLayer(filter_sizes[4], n_classes, n_classes)
        self.final2 = FinalLayer(filter_sizes[3], n_classes, n_classes)
        self.final3 = FinalLayer(filter_sizes[2], n_classes, n_classes)
        self.final4 = FinalLayer(filter_sizes[1], n_classes, n_classes)
        self.final5 = FinalLayer(filter_sizes[0], n_classes, n_classes)
